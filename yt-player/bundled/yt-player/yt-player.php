 ...
 * @fs_premium_only /admin/premium-files/class.settings-api.php, /admin/premium-files/, inc/Services/ShortcodePro.php, inc/Page/Settings.php, inc/PostType/YTPlayerPro.php
 */
//--------------Fremius Integration------------------
if ( function_exists( 'ytp_fs' ) ) {
    ...
    define( 'YTP_PLUGIN_VERSION', ( $_SERVER['HTTP_HOST'] === 'localhost' ? time() : '2.0.8' ) );
